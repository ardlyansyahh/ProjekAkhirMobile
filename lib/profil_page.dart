...
Widget _buttonHome(BuildContext context, String username) {
  return Container(
    child: FloatingActionButton(
...
Widget _buttonAbout(BuildContext context, String username){
  return Container(
    child: FloatingActionButton(
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(50),
...
Widget _buttonProfil(BuildContext context, String username){
  return Container(
    child: FloatingActionButton(
